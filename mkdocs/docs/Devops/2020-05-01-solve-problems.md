...
2. Resist the urge to get into solutioning during the ideation exercise. Ideation is really about imaging what new outcomes are possible for your Persona.
...
- Encourage wild ideas (have each team member offer at least one ABSURD idea)
- Review ideas later
- Stay on topic
- Be visual
...
- Although defining them may more complex. Hills statements should end up being very simple
- Understanding the project goal will allow teams to align to a single vision and to make the appropariate voices when defining the future experience.
...
- Get real! Show your design intention. Make it a concrete(具体的) representation. for example, expressed as a Persona, the Hills, a storyboard, or a wireframe being concrete helps avoid misinterpretation(误解), and leads to more effective feedback.
...
- If points of friction arise during the To-Be Scenario mapping exercise, continue empathizing with the Persona to achieve a more delightful outcome
- When in doubt about any step in the To-Be Scenario, do more research.
...
- When discussing early stage prototypes with Sponsor Users, design teams may hear signs of recognition and delight from the Sponsor User. This means their new game day experience design is likely to create a delightful experience for the Persona, but there is still need to playback often and gather more user research, especially as Prototypes become more high-level
- All ideas from Sponsor Users are valid, given their likeness to the Persona!
- You should probe(探测) for more details when a Sponsor User shares ideas and particulary if any issue arise with the new design
...
- https://www.toolshero.com/creativity/ibm-design-thinking/