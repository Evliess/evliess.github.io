...
4. Create a Dockerfile, Required ```EXPOSE 7860```
...
# 将构建好的 Angular 应用复制到 Nginx 的默认 HTML 目录
COPY learn-dict/browser/ /usr/share/nginx/html/

# （可选）如果你有自定义 nginx.conf，可以复制进来
  ...
  jupyter:
    ...
    steps:
      ...
      - name: Download cloudflared
        run: |
          wget https://github.com/cloudflare/cloudflared/releases/download/2023.12.0/cloudflared-linux-amd64 -O cloudflared
          chmod +x cloudflared
